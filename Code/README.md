...
- The Taxa-level analysis folder only contains the code for the generation of the visual comparison of taxa abundances, for the different phyla, before and after the treatment.
...
As a note, where the repository is provided as "---", the reader needs to substitute it with the repository where their data or intermediate results are.
