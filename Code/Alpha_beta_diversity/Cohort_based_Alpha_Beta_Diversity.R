...
## DIVIDE into the 1s and 0s 

## no_remission == 0
OTU_TABLE_MAGMA_no_remission <- otu_table_no_miss[!outcome,] 
# 69 x 95
OTU_TABLE_MAGMA_remission <- otu_table_no_miss[outcome,]





# Divided by Responder ----------------------------------------------------
